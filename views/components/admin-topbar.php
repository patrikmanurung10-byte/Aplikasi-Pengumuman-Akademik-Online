...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
        <!-- Brand -->
        <a class="navbar-brand d-flex align-items-center" href="<?php echo \App\Core\View::url('admin/dashboard'); ?>">
        ...
        <div class="d-none d-md-block">
            <h6 class="text-light mb-0">
                <i class="bi bi-<?php echo $page_icon ?? 'speedometer2'; ?> me-2"></i>
...
/* Consistent spacing for all admin pages */
.container-fluid {
    padding-left: 0;
    padding-right: 0;
}
...
@media (min-width: 992px) {
    .main-content {
        margin-left: 16.66667%; /* Account for sidebar width */
        padding-left: 1rem;
    }
