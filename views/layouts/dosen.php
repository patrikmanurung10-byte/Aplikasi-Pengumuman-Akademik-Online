...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - Dosen APAO' : 'Dosen APAO'; ?></title>
    ...
    <style>
        * {
        ...
        /* Other styles same as admin but with blue theme */
        .table th {
            border-top: none;
...
<div class="dosen-layout">
    ...
    <div class="sidebar" id="sidebar">
        <a href="/dosen/dashboard" class="sidebar-brand">
            <i class="bi bi-person-badge"></i>
            <span>APAO Dosen</span>
        </a>
        
        <div class="sidebar-menu">
            <div class="menu-item">
                <a href="/dosen/dashboard" class="menu-link <?php echo ($active_menu ?? '') === 'dashboard' ? 'active' : ''; ?>">
            ...
            <div class="menu-item">
                <a href="/dosen/announcements" class="menu-link <?php echo ($active_menu ?? '') === 'announcements' ? 'active' : ''; ?>">
            ...
            <div class="menu-item">
                <a href="/dosen/announcements/create" class="menu-link <?php echo ($active_menu ?? '') === 'create-announcement' ? 'active' : ''; ?>">
            ...
            <div class="menu-item">
                <a href="/dosen/profile" class="menu-link <?php echo ($active_menu ?? '') === 'profile' ? 'active' : ''; ?>">
    ...
    <div class="main-content">
        ...
        <div class="main-header">
            <div class="header-left">
                ...
                <h4><?php echo $page_title ?? 'Dashboard Dosen'; ?></h4>
                <p>Panel dosen APAO Polibatam</p>
            </div>
            ...
            <div class="header-right">
                ...
                <div class="dropdown">
                    <button class="btn btn-link d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                        <div class="user-info">
                            <div class="user-avatar">
                                <?php echo strtoupper(substr($_SESSION['full_name'] ?? 'DS', 0, 2)); ?>
                            </div>
                            <div class="user-details d-none d-md-block">
                                <h6><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Dosen'); ?></h6>
                                <small>Dosen</small>
                            </div>
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="/dosen/profile">
